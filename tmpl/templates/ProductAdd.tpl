...
<header class="title clearfix">
    <p class="fleft"></p>
    <a href="{$smarty.const.WEBROOT}/product/list" class="arrow more fright">{$lang['allProducts']}</a> </header>
...
<form method="POST" action="{$smarty.const.WEBROOT}/?action=productAdd" enctype="multipart/form-data" id="addProduct">
	<ul class="contact_ie9">
        ...
        <li>
            ...
            <select name="origin" id="origin" autofocus="autofocus">
		      ...
		      <option value="Belgium" data-alternative-spellings="BE Belgie Belgien Belgique" data-relevancy-booster="1.5">Belgium</option>
		      ...
		      <option value="Cóte d'Ivoire" data-alternative-spellings="CI Cote dIvoire">Cóte d'Ivoire</option>
		      ...
		      <option value="Curaćao" data-alternative-spellings="CW Curacao">Curaćao</option>
		      <option value="Cyprus" data-alternative-spellings="CY">Cyprus</option>
		      <option value="Czech Republic" data-alternative-spellings="CZ Ceska">Czech Republic</option>
		      ...
		      <option value="Estonia" data-alternative-spellings="EE Eesti" data-relevancy-booster="1.5">Estonia</option>
		      ...
		      <option value="Faroe Islands" data-alternative-spellings="FO" data-relevancy-booster="0.5">Faroe Islands</option>
		      ...
		      <option value="France" data-alternative-spellings="FR" data-relevancy-booster="2.5">France</option>
		      ...
		      <option value="Greenland" data-alternative-spellings="GL" data-relevancy-booster="0.5">Greenland</option>
		      ...
		      <option value="Ireland" data-alternative-spellings="IE" data-relevancy-booster="1.2">Ireland</option>
		      ...
		      <option value="Nigeria" data-alternative-spellings="NG Nijeriya" data-relevancy-booster="1.5">Nigeria</option>
		      ...
		      <option value="Reunion" data-alternative-spellings="RE Reunion">Reunion</option>
		      <option value="Romania" data-alternative-spellings="RO Rumania Roumania RomĆ¢nia">Romania</option>
		      ...
		      <option value="Slovakia" data-alternative-spellings="SK Slovensko">Slovakia</option>
		      ...
		      <option value="Spain" data-alternative-spellings="ES" data-relevancy-booster="2">Spain</option>
		      ...
		      <option value="Turkey" data-alternative-spellings="TR Turkiye">Turkey</option>
	...
	<a href="#" onclick="$('#addProduct').submit()" class="button">{$lang['save']}</a>
